...
test('private playground exposes the bounded R1.2 React component states', async () => {
  ...
  for (const component of ['Breadcrumbs', 'Checkbox', 'Autocomplete', 'CheckboxGroup', 'DateField', 'DatePicker', 'DateRangePicker', 'Form', 'NumberField', 'SearchField', 'Switch', 'TextField', 'TimeField', 'Disclosure', 'DisclosureGroup', 'Group', 'Link', 'Meter', 'ProgressBar', 'Separator', 'ToggleButton']) {
