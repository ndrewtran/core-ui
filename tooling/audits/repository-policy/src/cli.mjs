...
try {
  ...
  if (r1.mode === 'operation') {
    console.log(`[E-R1-01] private R1 operation passed (${r1.result.operationKind})`);
  } else {
    console.log('[E-R1-01] private R1 ChangeIntent gate explicit no-op; no operation was authorized');
  }
} catch (error) {
