# Foundation package navigation

`semantic/` owns cross-renderer meaning. `logic/` may depend on semantic and
owns pure derivation only. Platform globals, selectors, framework hooks, native
